/*
	...
	School info:	Brno University of Technology (VUT)
	...
	with hundreds to thousands light sources. To handle this there have been
...
/// <param name="spheric">indicates if texture will be mapped to sphere.</param>
/// <returns>TRUE on success.</returns>
bool Texture::Load(bool srgb, bool spheric)
{
	int x, y, n;
...
/// <summary>
/// Binds texture to specified texture unit, if texture does not contain any data
